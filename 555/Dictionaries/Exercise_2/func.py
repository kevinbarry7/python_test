...
def reports_above_temp(weather, temp):
    ...
    t = weather['2017-04-21T08:00:00-04:00']['temperature']['value']
    print(t)  # t contains the temp value
    unit = weather['2017-04-21T08:00:00-04:00']['temperature']['units']
    print(unit)
    if unit == 'F':
        temp_f = to_celsius(unit)
        print(temp_f)
