...
def get_minimums(cert, area, instructed, vfr, daytime, minimums):
    ...
    cats = ['Student', 'Certified', '50 Hours', 'Dual']
    flight_area = ['Pattern', 'Practice Area', 'Cross Country', 'Local', 'Any']
    if vfr == True:
        condition = 'VMC'
    else:
        condition = 'IMC'
    ...
    if cert == 0 or 1 and instructed == True:
         person = cats[0] or cats[3]
    elif cert == 0 or 1:
         person = cats[0]
    elif cert == 2 and instructed == True:
        person = cats[1] or cats[3]
    elif cert == 2:
        person = cats[1]
    elif cert == 3 and instructed == True:
        person = cats[2] or cats[3]
    elif cert == 3:
        person = cats[2]
