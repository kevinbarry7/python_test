...
if len(answer) == 0:
    ...
    print('The answer should take up three lines.')
    result = False
elif not 'Module funcs is working correctly' in answer:
    print('The output is not correct.')
    result = False
elif not 'Testing has_a_vowel' in answer:
    print('The output is not correct.')
    result = False
elif not 'Testing has_y_vowel' in answer:
    print('The output is not correct.')
    result = False
elif answer != ['Testing has_a_vowel','Testing has_y_vowel','Module funcs is working correctly']:
